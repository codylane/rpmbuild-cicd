...
License:        ASL 2.0
URL:            https://github.com/neovim/neovim/releases/download/v%{package_version}/nvim-linux64.tar.gz
Source0:        nvim-linux64.tar.gz
...
%prep
[ -f %{SOURCE0} ] || curl -L %{url} -o %{SOURCE0}

[ -f BACKERS.md ]      || curl -vk -L https://github.com/neovim/neovim/blob/master/BACKERS.md      -O
[ -f CONTRIBUTING.md ] || curl -vk -L https://github.com/neovim/neovim/blob/master/CONTRIBUTING.md -O
[ -f README.md ]       || curl -vk -L https://github.com/neovim/neovim/blob/master/README.md       -O

%build
tar zxvf %{SOURCE0}
[ -f LICENSE ] || curl -vk -L https://github.com/neovim/neovim/blob/master/LICENSE -O

%install
install -d -m 0755 %{buildroot}/usr
rm -rf %{_builddir}/nvim-linux64/share/locale
rsync -av %{_builddir}/nvim-linux64/ %{buildroot}/usr/
